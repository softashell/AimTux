...
int __attribute__((constructor)) AimTuxInit()
{
	...
	eventListener = new EventListener({ "cs_game_disconnected", "player_connect_full", "player_death", "player_hurt", "switch_team", "inferno_startburn", "inferno_expire", "round_prestart" });
